...
import 'package:Npay/HELPER/onboarding/page.dart';
import 'package:Npay/HELPER/onboarding/pageDragger.dart';
import 'package:Npay/HELPER/onboarding/pageIndicator.dart';
import 'package:Npay/HELPER/onboarding/pageIndicatorButton.dart';
import 'package:Npay/HELPER/onboarding/pageReveal.dart';
import 'package:Npay/MODEL/ONBOARDING/pageIndicator.dart';
import 'package:Npay/MODEL/ONBOARDING/pageViewModel.dart';
import 'package:flutter/material.dart';

import 'animatePageDragger.dart';
...
class IntroViewsFlutter extends StatefulWidget {
  ...
  IntroViewsFlutter(
      this.pages, {
        ...
        this.nextText = const Text("NEXT", style: TextStyle(fontFamily: 'Rubik')),
        this.skipText = const Text("SKIP", style: TextStyle(fontFamily: 'Rubik')),
        this.backText = const Text("BACK", style: TextStyle(fontFamily: 'Rubik')),
